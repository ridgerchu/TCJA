    ...
    class VGGNet_2(nn.Module):
        def __init__(self):
            ...
            self.fc = nn.Sequential(
                ...
                neuron.MultiStepLIFNode(tau=2.0, surrogate_function=surrogate.PiecewiseQuadratic(), detach_reset=True,
                                        backend='torch'),
            )
        ...
        def conv3x3(in_channels: int, out_channels):
            return [
                ...
                neuron.MultiStepLIFNode(tau=2.0, surrogate_function=surrogate.PiecewiseQuadratic(), detach_reset=True, backend='torch'),
            ]
