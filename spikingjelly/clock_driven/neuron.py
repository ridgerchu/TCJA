...
class MultiStepLIFNode(LIFNode):
    def __init__(self, tau: float = 2., decay_input: bool = True, v_threshold: float = 1.,
                 v_reset: float = 0., surrogate_function: Callable = surrogate.ATan(), v_rest: float = 0.,
                 detach_reset: bool = True, backend='cupy'):
        """
    ...
    def __init__(self, init_tau: float = 2., decay_input: bool = True, v_threshold: float = 1.,
        ...
        * :ref:`中文API <MultiStepParametricLIFNode.__init__-cn>`
        ...
        .. admonition:: Tip
            ...
            and multi-step propagation.
        """
        super().__init__(init_tau, decay_input, v_threshold, v_reset, v_rest, surrogate_function, detach_reset)
        self.register_memory('v_seq', None)
        self.register_memory('spike_seq', None)
